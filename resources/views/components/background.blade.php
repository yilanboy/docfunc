<div class="absolute right-1/2 top-0 -z-10 h-screen w-full max-w-[1920px] translate-x-1/2">
  <div id="background-right">
    ...
    <div class="absolute left-[24%] top-[18rem] hidden lg:block">
      <x-icons.person-walking class="size-24 -rotate-12 text-zinc-300/60 dark:text-zinc-950/80" />
    </div>
    ...
    <div class="absolute left-[2%] top-[38rem] hidden lg:block">
      <x-icons.easel class="size-24 rotate-12 text-zinc-300/60 dark:text-zinc-950/80" />
    </div>

    <div class="absolute left-[8%] top-[48rem] hidden lg:block">
      <x-icons.globe-americas class="size-24 -rotate-12 scale-x-[-1] text-zinc-300/60 dark:text-zinc-950/80" />
    </div>

    <div class="absolute left-[24%] top-[4rem] hidden lg:block">
      <x-icons.hand-thumbs-up class="size-24 rotate-12 text-zinc-300/60 dark:text-zinc-950/80" />
    </div>

    <div class="absolute left-[38%] top-[10rem] hidden lg:block">
      <x-icons.lightbulb class="size-24 -rotate-12 text-zinc-300/60 dark:text-zinc-950/80" />
    </div>

    <div class="absolute left-[38%] top-[26rem] hidden lg:block">
      <x-icons.battery-charging class="size-24 -rotate-12 text-zinc-300/60 dark:text-zinc-950/80" />
    </div>

    <div class="absolute left-[40%] top-[40rem] hidden lg:block">
      <x-icons.music-note-beamed class="size-24 rotate-12 text-zinc-300/60 dark:text-zinc-950/80" />
    </div>
  </div>
  ...
  <div id="background-right">
    ...
    <div class="absolute right-[34%] top-[24rem] hidden lg:block">
      <x-icons.cup-hot class="size-24 rotate-12 text-zinc-300/60 dark:text-zinc-950/80" />
    </div>

    <div class="absolute right-[46%] top-[30rem] hidden lg:block">
      <x-icons.clipboard-check class="size-24 rotate-12 text-zinc-300/60 dark:text-zinc-950/80" />
    </div>
    <div class="absolute right-[22%] top-[6rem] hidden lg:block">
      <x-icons.bug class="size-24 rotate-45 text-zinc-300/60 dark:text-zinc-950/80" />
    </div>

    <div class="absolute right-[4%] top-[12rem] hidden lg:block">
      <x-icons.folder-open class="size-24 rotate-12 text-zinc-300/60 dark:text-zinc-950/80" />
    </div>
    ...
    <div class="absolute right-[4%] top-[32rem] hidden lg:block">
      <x-icons.cpu class="size-24 -rotate-12 text-zinc-300/60 dark:text-zinc-950/80" />
    </div>

    <div class="absolute right-[20%] top-[40rem] hidden lg:block">
      <x-icons.terminal class="size-24 rotate-12 text-zinc-300/60 dark:text-zinc-950/80" />
    </div>
