        ...
        <div class="flex w-full max-w-3xl flex-col items-center justify-start px-2 xl:px-0">
          ...
          >
            <article>
              {{-- post title --}}
              <h1
                class="dark:text-lividus-500 dark:from-lividus-800/60 bg-linear-to-r -mx-4 -mt-4 rounded-t-xl from-emerald-100/80 to-transparent px-4 py-6 text-4xl font-semibold leading-relaxed text-emerald-600"
              >
                {{ $post->title }}
              </h1>
